...
% initialization
M=4;LL=1000;threshold=0.37;n_L_0=0;T=4;ts=0.01;v_set=[1 32];c_init=10;L=8;beta=0.5;
...
legend([p1 p2 p3],{'CRVB','L_0=32,v=1','L_0=32,v=32'})
ylabel('MSE(M\delta)')
xlabel('E_s/N_0(dB)')
title('\delta=0.001')
...
legend([p6 p7 p8],{'CRVB','L_0=32,v=1','L_0=32,v=32'})
ylabel('MSE(\phi)')
xlabel('E_s/N_0(dB)')
title('\delta=0.001')