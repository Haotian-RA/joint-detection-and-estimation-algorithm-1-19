...
%                     phasor_v_SD=exp(1i*normalized_true_phase_offset);
            ...
            P_d(n_thres,n_snr,n_M)=n_d/LL; % (threshold,snr,v)
            P_fa(n_thres,n_snr,n_M)=n_fa/LL;
        end
    end
end
...
legend('L_0=32,SNR=0dB,no pulse','L_0=32,SNR=0dB,M=4','Location','southwest')
title('\delta=0.00025')
