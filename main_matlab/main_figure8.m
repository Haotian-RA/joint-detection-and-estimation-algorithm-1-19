        ...
        for count=1:LL
            ...
            for win=0:length(rec)-N
                ...
                for v=v_set
                    ...
                    if n_P==1
                        detection_board1(:,win+1) = detect_preamble(threshold,rho);
                    elseif n_P==2
                        detection_board2(:,win+1) = detect_preamble(threshold,rho);
                    end
...
legend('L_0=32,SNR=-5dB,v=1','L_0=32,SNR=0dB,v=1','L_0=32,SNR=10dB,v=1','L_0=32,SNR=-5dB,v=32','L_0=32,SNR=0dB,v=32','L_0=32,SNR=10dB,v=32','Location','southwest')
title('\delta=0.001')
...
ylabel('P_{d}')
% legend('L_0=32,SNR=-5dB,v=1','L_0=32,SNR=-2dB,v=1','L_0=32,SNR=0dB,v=1','L_0=32,SNR=5dB,v=1','L_0=32,SNR=10dB,v=1','L_0=32,SNR=-5dB,v=32','L_0=32,SNR=-2dB,v=32','L_0=32,SNR=0dB,v=32','L_0=32,SNR=5dB,v=32','L_0=32,SNR=10dB,v=32')
legend('L_0=32,SNR=-5dB,v=1','L_0=32,SNR=0dB,v=1','L_0=32,SNR=10dB,v=1','L_0=32,SNR=-5dB,v=32','L_0=32,SNR=0dB,v=32','L_0=32,SNR=10dB,v=32','Location','southeast')
title('\delta=0.001')
