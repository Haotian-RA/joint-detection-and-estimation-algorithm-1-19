...
% channel
M=2;
% normalized_true_freq_offset=0.001/M; 
normalized_true_freq_offset=0.02/M; 
...
LL=100; 
n_L_0=0;  
L=8;beta=0.5;c_init=10;v_set=[32];
...
Bound_SD=bound_SD(N,SNR,M,1,normalized_true_freq_offset);
figure(1)
...
legend('CRVB','SD bound','impro_{SD1}','impro_{SD32}')
ylabel('MSE(M\delta)')
xlabel('E_s/N_0(dB)')
...
% grid on
% legend('CRVB','impro_{NM1}','impro_{NM32}') 
% ylabel('MSE(M\delta)')
% xlabel('E_s/N_0(dB)')

% MSE_block_v_SD_0001_M_2=MSE_block_v_SD;

% save('new_1_MSE_block_v_SD_0001_M_2.mat','MSE_block_v_SD_0001_M_2')
% MSE_delta_NM_M_2=MSE_impro_NM;
% save('new_1_MSE_delta_NM_M_2.mat','MSE_delta_NM_M_2')
